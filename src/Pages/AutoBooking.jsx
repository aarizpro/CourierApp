  ...
  return (
    <div className="grid gap-2 p-2">
      ...
      <div className="grid grid-cols-3 gap-4 items-center">
        ...
        <img src={courierImg} alt="Courier" className="w-full h-full object-contain" />
      </div>
      ...
      <div className="grid grid-cols-2 gap-4 items-center">
        ...
        />
        {isButtonVisible && ( 
        <button className="bg-blue-500 text-white p-2 rounded shadow" onClick={saveBooking}> Book </button>
        )}
        </div>
      <div className="p-4">
